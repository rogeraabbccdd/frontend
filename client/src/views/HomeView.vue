<template>
	<div>
		...
		<!-- 6. 工程思維與 AI 協同 (在 AI 時代，我們培養的是能完成產品的人) -->
		...
		<section class="section-shell bg-slate-950/50 text-center relative overflow-hidden">
			<!-- 柔和微光 -->
			<div
		...
		<section
			class="section-shell bg-gradient-to-b from-slate-950/60 via-slate-900/40 to-slate-950 text-center relative overflow-hidden"
		>
			<!-- 柔和環境光暈 -->
			<div
